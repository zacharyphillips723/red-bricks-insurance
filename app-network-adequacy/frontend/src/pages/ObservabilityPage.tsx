...
export function ObservabilityPage() {
  ...
  if (loading) return <div className="flex items-center justify-center h-64"><Loader2 className="w-8 h-8 text-databricks-red animate-spin" /></div>;
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">MLflow traces and model usage for the Network Agent, captured in Unity Catalog OTel tables.</p>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              ...
              {traces.length === 0 && <tr><td colSpan={5} className="px-4 py-8 text-center text-gray-400">No traces yet. Ask the Network Agent a question to generate traces.</td></tr>}
            </tbody>
          </table>
        </div>
      </div>
