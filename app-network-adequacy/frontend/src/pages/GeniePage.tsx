...
const SUGGESTED_QUESTIONS = [
  ...
  "Show me ghost-flagged providers with high severity in Wake County",
  "What specialties have the highest out-of-network leakage cost?",
  "How many members are affected by non-compliant county-specialty combinations?",
  "Which OON providers should we prioritize for recruitment?",
  "Compare telehealth availability across rural vs metro counties",
];
    ...
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      <div className="mb-4">
        <h2 className="text-2xl font-bold text-databricks-dark flex items-center gap-2">
          <Sparkles className="w-6 h-6 text-databricks-red" /> Network Analytics
        </h2>
        <p className="text-sm text-gray-500 mt-1">
          Ask natural language questions about network adequacy data using Databricks Genie
        </p>
      </div>
        ...
        {responses.length === 0 && !loading && (
          <div className="card p-8 text-center">
            ...
            <h3 className="text-lg font-semibold text-databricks-dark mb-2">
              Ask anything about network adequacy
            </h3>
        ...
        <div className="flex gap-3">
          <div className="flex-1 relative">
            ...
            <input
              ...
              placeholder="Ask about compliance, ghost networks, leakage, gaps..."
