...
const COST_PER_1K: Record<string, { input: number; output: number }> = {
  ...
  "databricks-gemini-2-5-pro": { input: 0.00125, output: 0.01 },
};
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Model usage, costs, and traces across Llama 4 Maverick and Gemini 2.5 Pro.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {(costs.length > 0 ? costs : [
          ...
          { endpoint: "databricks-gemini-2-5-pro", request_count: 0, total_input_tokens: 0, total_output_tokens: 0, avg_latency_ms: 0 },
        ]).map((c) => {
