...
export function Sidebar({ activePage, onNavigate, openCount }: SidebarProps) {
  return (
    <aside className="w-64 bg-databricks-dark min-h-screen flex flex-col">
      {/* Logo */}
      <div className="px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          <ShieldAlert className="w-7 h-7 text-databricks-red" />
          <div>
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.id === "investigations" && openCount > 0 && (
